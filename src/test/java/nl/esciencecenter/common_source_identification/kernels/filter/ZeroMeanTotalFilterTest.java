 ...
 * @version 0.1
 */
public class ZeroMeanTotalFilterTest extends AbstractFilterTest {
	@Test
	public void applyGPUTest() {
		float[][] pixelsCPU = Util.copy(pixels);
		filter.getZeroMeanTotalFilter().applyCPU(pixelsCPU);
		...
		filter.getZeroMeanTotalFilter().applyGPU(dmem);
